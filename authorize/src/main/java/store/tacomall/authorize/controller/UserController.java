...
public class UserController {
    ...
    public AuthorizeDto<String> genAccessToken(@RequestParam(value = "issuer") String issuer, @RequestBody JSONObject json)
            throws Exception {
        return userService.genAccessToken(issuer, json);
    }

    @PostMapping("verifyAccessToken")
    public AuthorizeDto<Map<String, String>> verifyAccessToken(@RequestParam(value = "issuer") String issuer,
