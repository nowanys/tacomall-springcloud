...
public interface UserService {
    ...
    AuthorizeDto<String> genAccessToken(String issuer, JSONObject json) throws Exception;

    AuthorizeDto<Map<String, String>> verifyAccessToken(String issuer, String token) throws Exception;
}
